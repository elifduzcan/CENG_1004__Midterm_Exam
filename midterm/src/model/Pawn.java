...
public class Pawn extends Piece {
    ...
    public boolean canMove(Square targetSquare) {
        ...
        if (pieceInTargetSquare == null) { // targetSquare de taş yoksa düz hareket etcek
            if (targetSquare.getColumn() == this.getColumn()) { // düz hareket edebilmesi için target ve şu anki columnlar aynı olmalı, değilse çık
        ...
        } else if (targetSquare.getColumn() != this.getColumn()) { // target squarede taş varsa aynı columnda hareket edemez, taş yer
